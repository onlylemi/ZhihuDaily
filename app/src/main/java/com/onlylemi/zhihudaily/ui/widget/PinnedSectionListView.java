package com.onlylemi.zhihudaily.ui.widget;
...
import com.onlylemi.zhihudaily.BuildConfig;

/**
 * PinnedSectionListView
 *
 * @author: onlylemi
 * @time: 2016-06-26 17:31
 */
public class PinnedSectionListView extends ListView {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view, PinnedSectionListView
                .this);
    ...
    void ensureShadowForPosition(int sectionPosition, int firstVisibleItem, int visibleItemCount) {
        if (visibleItemCount < 2) { // no need for creating shadow at all, we have a single
            // visible item
            destroyPinnedShadow();
            return;
        }
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (BuildConfig.DEBUG && adapter != null) {
            if (!(adapter instanceof PinnedSectionListAdapter))
                throw new IllegalArgumentException("Does your adapter implement " +
