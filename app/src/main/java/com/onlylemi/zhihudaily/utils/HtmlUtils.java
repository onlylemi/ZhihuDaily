...
public class HtmlUtils {
     ...
     * @return String
     */
    public static String createHtmlData(NewsDetail news) {
        final String css = HtmlUtils.createCssTag(news.getCss());
        final String js = HtmlUtils.createJsTag(news.getJs());
